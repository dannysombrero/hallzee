...
- Classroom dashboard, roster, trip history and CSV reports.
- Teacher workspaces, bell schedules and optional terminal bell-time lockouts.
- Remembered Bluetooth pairing, automatic reconnect and trip sync.
...
and may need school IT approval. Hardware and clean-machine acceptance must be
completed before these notes accompany a public production release.
