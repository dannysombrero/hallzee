...
are copyright © 2026 Hallzee Labs. See [COPYRIGHT](../COPYRIGHT).

| Material | License |
| --- | --- |
| Original software, firmware, tools, and tests | AGPL-3.0-or-later; full text in [LICENSE](../LICENSE) |
| Hardware designs and model files in `models/` | CC BY-SA 4.0; see [models/LICENSE](../models/LICENSE) |
| Third-party code and fonts | Their upstream licenses; see [THIRD-PARTY-NOTICES.md](../THIRD-PARTY-NOTICES.md) |
