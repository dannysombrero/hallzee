...
2. Choose and commit a software license (for example MIT or Apache-2.0) in
   `LICENSE`; without one, others can read the code but do not have clear reuse
   permission. Add a short contribution policy and security contact when ready.
