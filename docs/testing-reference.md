# Historical testing and hardware reference

This page preserves the detailed regression notes and hardware reference from
...
[Bluetooth acceptance checklist](#windows--mac-bluetooth-verification) remain
...
[Wokwi guide](../firmware/terminal/WOKWI.md).
