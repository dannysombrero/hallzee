...
This browser preview is the canonical UX prototype for Hallzee's desktop client. It uses mock services and simulates terminal discovery, trip synchronization, roster import, policy management, and pass occupancy without requiring Bluetooth hardware or SQLite setup.

## Structure

- `app/page.tsx` is the root route entry point.
