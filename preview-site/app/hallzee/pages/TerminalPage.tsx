...
import { TerminalContent } from "../components/TerminalSettingsModal";
    ...
    <div className="space-y-6 pb-24">
      <section className="bg-white/95 border border-sky-200/80 rounded-3xl p-6 shadow-lg">
        <div className="flex items-center gap-3 border-b border-sky-100 pb-4 mb-4">
          ...
          <div>
            <h1 className="text-xl font-black text-slate-900">Terminal Settings</h1>
            <p className="text-xs text-slate-500 font-medium mt-0.5">
              Configure kiosk parameters, maximum student ID length, and connection status
            </p>
          </div>
        </div>
        <TerminalContent />
