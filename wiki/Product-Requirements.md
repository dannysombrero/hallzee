...
- **FR-ROST-4:** Rosters must be scoped per classroom profile (e.g., Period 1 vs. Period 2).

### 3.4 Classroom Profiles, Policies & Bell Schedules
- **FR-POL-1:** The system must support multiple classroom profiles representing different classes, periods, or rooms.
- **FR-POL-2:** Teachers must be able to configure pass policies per profile:
